...
abr5_brailleData = pd.read_csv(r'C:\Users\yang\Desktop\Coding\Braille-Translator\alternate meanings - abr5.csv')
df_abr5_brailleData = pd.DataFrame(abr5_brailleData)

abr4_brailleData = pd.read_csv(r'C:\Users\yang\Desktop\Coding\Braille-Translator\alternate meanings - abr4.csv')
df_abr4_brailleData = pd.DataFrame(abr4_brailleData)

abr3_brailleData = pd.read_csv(r'C:\Users\yang\Desktop\Coding\Braille-Translator\alternate meanings - abr3.csv')
df_abr3_brailleData = pd.DataFrame(abr3_brailleData)

abr2_brailleData = pd.read_csv(r'C:\Users\yang\Desktop\Coding\Braille-Translator\alternate meanings - abr2.csv')
